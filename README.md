...
Hi, this is my frontend exercise for xtream.
I completed the first challenge, build a page and renderthe posts on the screen, allow the user to perform crud operations, redesign the posts (50), support mobile portrait and add some kind of animations.
I didn't complete number 2 and three challenge but for the third one I would like to start learning more about react native and Flutter.

To see the page, i'm going to explain you how to run it.

### First step

You have to clone this repo locally with the command
`git clone` with the name of this repository
`https://github.com/MLLuisa/interviews-web-mobile-assignment.git` ;

### Second step

You have to install al the dependecies with this command
`npm install` ;
